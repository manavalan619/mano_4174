...
DESKTOPCODE='../../../application/client/desktop/mano_4174'
DESKTOPIMAGENAME='geppettotest/mano_4174-desktop:1.0'
...
helm install --name mano_4174 ./helm
if [ $? -eq 0 ]; then
